  ...
  return (
    <div className="container mx-auto p-8 grid grid-rows-1 gap-10 max-md:grid-cols-1">
      <div>
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="flex gap-2">
            <input
              className="bg-gray-50 border border-gray-300 w-1/6 p-2 rounded-lg"
              value={newRole}
            ...
            <button
              ...
              type="submit"
              className="bg-gray-800 hover:bg-gray-600 w-1/12 p-2 rounded-lg text-white"
            >
              Save
            </button>
          </div>
      ...
      <div className="relative h-screen">
        <h1 className="text-4xl font-bold uppercase pb-16">List of Roles</h1>
